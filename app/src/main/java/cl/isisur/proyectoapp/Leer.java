        ...
        try{
            ...
            if(c.moveToFirst())
            {
                do{
                    ...
                    persona.fecha = c.getString(fecha);
                    persona.correo = c.getString(correo);
                    persona.telefono = c.getString(telefono);
                    lista.add(persona);

                    arreglo.add(c.getString(id) + " \t " + c.getString(nombre) + " \t "  + c.getString(apellido) + " \t "  + c.getString(fecha)+ " \t " + c.getString(correo)+ " \t " + c.getString(telefono) );
